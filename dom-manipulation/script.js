...
// });
//----------------------------------------------------
// QUOTE STORAGE SETUP (LOCAL + SESSION)
//----------------------------------------------------
let quotes = [];
...
function displayRandomQuote() {
    ...
    document.getElementById("quoteDisplay").innerText = `"${randomQuote.quote}" — ${randomQuote.author}`;

    // Save to session storage
    saveLastViewed(randomQuote.quote);
}
